...
##### ADDED BY Michelotti ########
import odatix.components.run_analysis as analyse
######################################
...
class ArgParser:
  ...
  def parse_arguments():
    ...
    # Define parser for the 'analyse' command
    # ADDED BY Michelotti
    ArgParser.analyse_parser = subparsers.add_parser( "analyse", help="run rtl analysis")
    analyse.add_arguments(ArgParser.analyse_parser)
    ArgParser.add_nobanner(ArgParser.analyse_parser)
    #######################################################
  ...
  def help():
    ...
    ArgParser.analyse_parser.print_help()
    print()
    ######################################################
...
############################ ADDED BY Michelotti #########################
########### def function for a new command: odatix analyse ###############
